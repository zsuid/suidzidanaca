...
// Movement, collision detection etc.
    ...
    public void draw() {
        ...
        if (mOurHolder.getSurface().isValid()) {
            ...
            mCanvas.drawColor(Color.argb(255, 255, 217, 0));

            // Choose the brush color for drawing
            mPaint.setColor(Color.argb(255, 0, 0, 142));
            // Draw the mPaddle
            ...
            // Choose the brush color for drawing
            mPaint.setColor(Color.argb(255, 187, 255, 19));

            // Draw the mScore
            mPaint.setTextSize(40);
            mCanvas.drawText("Score: " + mScore + "   Lives: " + mLives, 13, 60, mPaint);
