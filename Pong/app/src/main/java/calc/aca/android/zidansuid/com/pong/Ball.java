...
// adding the ball constructor method
public Ball(int screenX, int screenY){
  ...
  */
   ...
   //we will code a getter method so we can get a hold of the RectF
   // Give access to the Rect
    public RectF getRect(){
    return mRect;
    }
    //Add the update method to the Ball class
    ...
    // add helper methods that deal withg various situation
    ...
    //Each of these methods simply tweaks/repositions the ball
